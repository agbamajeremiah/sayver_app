var routes = [
	...
	// asset page
	{
		...
		componentUrl: './pages/assets.html',
		name: 'assets',
	...
	// withdraw page
	{
		...
		componentUrl: './pages/withdraw.html',
		name: 'withdraw',
	},
	// Right Panel pages
	{
	...
	{
		path: '/fund/',
		componentUrl: './pages/fundaccount.html',
	},
	// Withdraw page
	{
		path: '/withdraw/',
	...
	{
		path: '/withdrawasset/',
		componentUrl: './pages/withdrawasset.html',
	},
	// withdraw asset page
	{
		path: '/withdrawearnings/',
		componentUrl: './pages/withdrawearnings.html',
	},
	// withdraw asset page
	{
		path: '/withdrawall/',
		componentUrl: './pages/withdrawall.html',
	},
	// thankyou page
	{
		path: '/thankyou/',
